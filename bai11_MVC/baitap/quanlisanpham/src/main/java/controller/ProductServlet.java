...
public class ProductServlet extends HttpServlet {
    ...
    private void deleleProduct(HttpServletRequest request, HttpServletResponse response) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "view":
                ...
                break;
            case "search":
                showSearchdForm(request, response);
            default:
    ...
    private void showSearchdForm(HttpServletRequest request, HttpServletResponse response) {
